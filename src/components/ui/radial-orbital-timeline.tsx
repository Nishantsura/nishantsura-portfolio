                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      {item.skills && (
                        <div className="mt-3 pt-3 border-t border-white/10">
                          ...
                          <div className="text-xs text-white/80">{item.skills}</div>
                        </div>
                      )}
                      ...
                      {item.url && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <Button
                            variant="outline"
                            size="sm"
                            className="w-full h-8 text-xs border-white/30 bg-transparent hover:bg-white/10 text-white hover:text-white transition-all"
                            onClick={(e) => {
                              e.stopPropagation();
